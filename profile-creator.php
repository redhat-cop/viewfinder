 ...
 *
 * Web-based tool for creating new assessment profiles
...
<head>
  ...
  <title>Profile Creator - Viewfinder Maturity Assessment</title>
...
<body>
  ...
  <div class="wizard-container">
    <h1>Profile Creation Wizard</h1>
    <p>Create a new assessment profile with custom domains and capabilities</p>
    ...
    <div class="wizard-nav">
      ...
      <button id="generateBtn" class="ui-button ui-widget ui-corner-all" style="display: none;">
        <i class="fa fa-check"></i> Generate Profile
      </button>
    </div>
  </div>

  <!-- Load wizard JavaScript -->
  <script src="js/profile-wizard.js"></script>
  ...
  <footer style="text-align: center; color: #999; padding: 2rem; margin-top: 2rem;">
    ...
    <p><small>Profile Creator Tool - For creating custom assessment profiles</small></p>
  </footer>
</body>
</html>
